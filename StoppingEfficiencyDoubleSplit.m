function [total_samples_slep_bound, total_samples_bonf_bound, total_samples_exact] = StoppingEfficiencyDoubleSplit(post_obj, alloc_rule, known_var, k, n0, M, Q)
...
parfor m = 1:M % loop over macroreplications
    ...
    % mu_i ~ -Weibull(a = 3 (scale), b = 2 (shape))
    mu = -wblrnd(3, 2, [1, k]);
    %mu = -chi2rnd(4, [1, k])
